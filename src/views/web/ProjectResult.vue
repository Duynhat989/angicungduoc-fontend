      ...
      <div class="row">
        <div class="project">
          <div class="row">
            ...
            <div class="col-9">
                <div class="project-body__checker">
                    <div class="title"><h3>Thông tin bài đăng</h3></div>
                </div>
            </div>
          </div>
        </div>
...
.nav-bar .nav-bar__item{
  ...
  border-radius: 8px;
  box-shadow: 1px 1px 1px 1px #96cdfb;
  transition: all 0.5s;
  padding-left: 30px;
  color: rgb(142, 139, 139);
}
.nav-bar__item:hover{
  box-shadow:5px 4px 4px 2px #96cefb97;
  cursor: pointer;
